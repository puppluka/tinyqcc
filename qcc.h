...
FILE: qcc.h
DESCRIPTION: 
The primary global header file that ties the entire QuakeC compiler together. 
It aggregates standard C libraries, the command-line utility headers, and the 
bytecode architecture definitions. More importantly, it declares the extensive 
global state required during compilation—including string heaps, statement 
lists, function tables, and global data blocks—making these structures 
