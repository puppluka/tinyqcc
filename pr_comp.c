...
FILE: pr_comp.c
DESCRIPTION: 
The core QuakeC parser and syntax evaluator. This module processes the token 
stream generated by the lexer, enforces QuakeC grammar rules, and translates 
high-level scripts into low-level virtual machine opcodes. It is responsible 
for managing variable scope, evaluating complex mathematical and logical 
expressions, performing aggressive constant folding on floats and vectors, 
and directly emitting the raw bytecode statements and global definitions into 
memory.
==============================================================================
*/
#include "qcc.h"
